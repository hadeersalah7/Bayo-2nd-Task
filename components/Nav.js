...
<div className='nav'>
    {/* <Col xs={6}> */}
        <div className='nav-container'>
       <div className='acme'>
        <span onClick={toggleDropdown}><i  className={`ri-arrow-${showDropdown ? "up" : "down"}-s-line`} id="arrow"></i>
 </span> 
...
<div className='logos'>
    <div className='setting'>
        <button className='btn1'><img src={settinIcon} className='logo1' alt='setting'/><span>Settings</span></button>
    </div>

    <div className='logout'>
<button className='btn2'><img src={logout} className='logout-logo'/><span>Logout</span></button>     
    </div>
</div>
